...
public class ServerHanler {
	...
	public boolean isStop = false, isExit = false;
        public ServerCoreCallback callback;
	
	//Intial server socket
	public ServerHanler(int port, ServerCoreCallback callback) throws Exception {
	...
	public class WaitForConnect extends Thread {
        ...
        public interface ServerCoreCallback{
            void updateNumberClient();
            void decreaseNumberClient();
        }
}
